    ...
    if len(TRADED_SYMBOL) == 0 :
        ...
        try:
            ...
            if len(df_nifty) != None :
                ...
                if (df_nifty['CROSS_UP'].iloc[-1] == 1 or df_nifty['CROSS_UP'].iloc[-2] == 1) and check_adx(df_nifty) == 1 and nifty_ta() == 1:
                ...
                if (df_nifty['CROSS_DOWN'].iloc[-1] or df_nifty['CROSS_DOWN'].iloc[-2] == 1) and check_adx(df_nifty) == 1 and nifty_ta() == 2:
